...
urlpatterns = [
    ...
    path('post/new/', views.new_view, name='new-post'),
    path('post/<int:pk>/vote/', views.vote_view, name='vote'),
    ...
    path('post/<int:post_id>/comment/', views.CreateCommentView.as_view(), name='comment'),
]